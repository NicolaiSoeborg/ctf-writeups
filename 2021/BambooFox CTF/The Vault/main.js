...
function win(flag) {
    alert(`You win! Here is you flag: ${UTF8ToString(flag)}`)
}
...
var ___em_js__banner = Module["___em_js__banner"] = function() {
    return (___em_js__banner = Module["___em_js__banner"] = Module["asm"]["i"]).apply(null, arguments)
};
var ___em_js__get_password = Module["___em_js__get_password"] = function() {
    return (___em_js__get_password = Module["___em_js__get_password"] = Module["asm"]["j"]).apply(null, arguments)
};
var ___em_js__fail = Module["___em_js__fail"] = function() {
    return (___em_js__fail = Module["___em_js__fail"] = Module["asm"]["k"]).apply(null, arguments)
};
var ___em_js__win = Module["___em_js__win"] = function() {
    return (___em_js__win = Module["___em_js__win"] = Module["asm"]["l"]).apply(null, arguments)
};
