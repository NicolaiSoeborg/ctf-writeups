...
import android.support.constraint.C0001R;
...
public class ConstraintSet {
    ...
    static {
        ...
        mapToConstant.append(C0001R.styleable.ConstraintSet_layout_constraintLeft_creator, 75);
        mapToConstant.append(C0001R.styleable.ConstraintSet_layout_constraintTop_creator, 75);
        mapToConstant.append(C0001R.styleable.ConstraintSet_layout_constraintRight_creator, 75);
        mapToConstant.append(C0001R.styleable.ConstraintSet_layout_constraintBottom_creator, 75);
        mapToConstant.append(C0001R.styleable.ConstraintSet_layout_constraintBaseline_creator, 75);
        ...
        mapToConstant.append(C0001R.styleable.ConstraintSet_android_rotation, 60);
        ...
        mapToConstant.append(C0001R.styleable.ConstraintSet_layout_constraintCircle, 61);
        mapToConstant.append(C0001R.styleable.ConstraintSet_layout_constraintCircleRadius, 62);
        mapToConstant.append(C0001R.styleable.ConstraintSet_layout_constraintCircleAngle, 63);
        mapToConstant.append(C0001R.styleable.ConstraintSet_android_id, 38);
        mapToConstant.append(C0001R.styleable.ConstraintSet_layout_constraintWidth_percent, 69);
        mapToConstant.append(C0001R.styleable.ConstraintSet_layout_constraintHeight_percent, 70);
        mapToConstant.append(C0001R.styleable.ConstraintSet_chainUseRtl, 71);
        mapToConstant.append(C0001R.styleable.ConstraintSet_barrierDirection, 72);
        mapToConstant.append(C0001R.styleable.ConstraintSet_constraint_referenced_ids, 73);
        mapToConstant.append(C0001R.styleable.ConstraintSet_barrierAllowsGoneWidgets, 74);
    }
    ...
    /* JADX WARN: Type inference failed for: r9v0, types: [android.support.constraint.ConstraintSet] */
    /* access modifiers changed from: package-private */
    public void applyToInternal(ConstraintLayout constraintLayout) {
        int count = constraintLayout.getChildCount();
        HashSet<Integer> used = new HashSet<>(((ConstraintSet) this).mConstraints.keySet());
        for (int i = 0; i < count; i++) {
            View view = constraintLayout.getChildAt(i);
            int id = view.getId();
            if (id == -1) {
            ...
            if (((ConstraintSet) this).mConstraints.containsKey(Integer.valueOf(id))) {
                used.remove(Integer.valueOf(id));
                Constraint constraint = ((ConstraintSet) this).mConstraints.get(Integer.valueOf(id));
                if (view instanceof Barrier) {
        ...
        while (it.hasNext()) {
            Integer id2 = it.next();
            Constraint constraint2 = ((ConstraintSet) this).mConstraints.get(id2);
    ...
    /* JADX INFO: Multiple debug info for r8v1 int: [D('constraintLayout' android.support.constraint.ConstraintLayout), D('count' int)] */
    private int[] convertReferenceString(View view, String referenceIdString) {
        ...
        while (i < split.length) {
            ...
            int tag = 0;
            try {
                tag = C0001R.id.class.getField(idString).getInt(null);
            } catch (Exception e) {
            }
            if (tag == 0) {
